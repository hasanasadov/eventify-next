...
const Navbar = () => {
  return (
    <>
      <div
        className="md:px-8 glassss  px-1 md:py-3 py-1 flex md:justify-between items-center !sticky top-0 z-50 border-bo border-gray-200 backdrop-blur-md !bg-transparen !bg-white/80 dark:!bg-background/30"
