...
const VenueSideBarItem = ({ venue }) => {
  ...
  return (
    <Link
      ...
      className="bg-white dark:bg-white/10 glass-border hover:border-blue-300 duration-200 flex items-center flex-col p-4 gap-4 w-[90%] border-2  transition-all rounded-lg relative "
    >
